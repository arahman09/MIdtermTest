...
public class ConnectToSqlDB {
    ...
    public static Properties loadProperties() throws IOException{
        ...
        InputStream ism = new FileInputStream("/Volumes/D/midTerm/MidtermMarch2020/src/secret.properties");
        prop.load(ism);
        ism.close();
        return prop;
        ///Volumes/D/midTerm/MidtermMarch2020/src/secret.properties
        ///Volumes/D/midTerm/MidtermMarch2020/src/secret.properties
    }
    ...
    public static List<User> readUserProfileFromSqlTable()throws IOException, SQLException, ClassNotFoundException{
        ...
        try{
            ...
            while (rs.next())
            {
                ...
                System.out.format("%s, %s,%s",name,id,dob);
